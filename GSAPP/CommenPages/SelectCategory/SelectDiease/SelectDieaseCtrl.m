...
@implementation SelectDieaseCtrl
...
- (void)initUI
{
    ...
    [HKCommen addHeadTitle:@"选择疾病种类" whichNavigation:self.navigationItem];
...
- (void)getModel
{
    [[NetworkManager shareMgr] server_fetchSymptomWithDic:nil completeHandle:^(NSDictionary *response) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.delegate handleDieaseSelectedWithDic:[self.arrayModel objectAtIndex:indexPath.row]];
}
